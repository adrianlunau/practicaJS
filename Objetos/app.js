...
// Debés crear una función llamada arregloDeObjetosDos que reciba un número y una palabra como parámetro y 
// devuelva un arreglo de objetos que tenga: una propiedad llamada como la palabra pasada por parámetro y el valor del número y sus anteriores.
...
function arregloDeObjetosDos(numero, string) {
    let resultado = [];
...
console.log(arregloDeObjetosDos(5, "palabra"))